...
public class DCCValueBeanFactory implements BeanPostProcessor {
    ...
    private static final String BASE_CONFIG_PATH = "group_buy_market_dcc_";// 配置在 Redis 中的键前缀

    private final RedissonClient redissonClient;

    private final Map<String, Object> dccObjGroup = new HashMap<>();//缓存：Redis 键 -> 对应的 Bean 对象（用于动态更新）
